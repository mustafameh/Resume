...
\vspace{0.05 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Building agentic systems for CoCounsel, TR's AI legal assistant, that extract risks across M\&A due diligence documents, working with lawyers to encode their methodologies, identifying 90\%+ of material risks.
                \item Designed an adversarial evaluation pipeline with 90\%+ failure detection (0.78 Cohen's Kappa vs. expert grades), replacing manual grading and reducing evaluation cycles from days to hours.
                \item Built an orchestrator agent harness and the skill library powering it, comprising modular sub-skills for risk analysis, fact extraction, and document classification, validated through SME evaluations.
                ...
                \item Fine-tuned LLMs for long-form contract drafting, customization, and summarization.
            \end{highlights}
        \end{onecolentry}
...
\vspace{0.06 cm}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Engineered feature extraction pipelines to transform EEG and eye-tracking clinical data into structured features: coherence, Hjorth parameters, and spectral power bands for EEG; gaze patterns and fixation analysis for eye-tracking.
                \item Built diagnostic classifiers reaching 80\% accuracy for Parkinson's and 82\% for Schizophrenia from EEG signals, and 92\% for autism by representing gaze scanpaths as images and training a custom transfer-learning computer vision model.
            \end{highlights}
        \end{onecolentry}  
...
\item Built an interactive story mode where users play as characters in branching Sherlock Holmes mysteries through structured decisions and free-form actions, using templated prompts with streaming structured output to deliver real-time scene generation and auto-generated context summaries.
