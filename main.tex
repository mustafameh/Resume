...
PyTorch, TensorFlow, Hugging Face (Transformers, trl), scikit-learn, LangChain, LangGraph, Pydantic AI, spaCy, vLLM, Flask, pandas, NumPy, Weights \& Biases, Gradio/Streamlit, Claude Agent SDK
\end{onecolentry}
