...
\vspace{0.05 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Hired as 4-month intern initially; contract extended based on performance to take full-time Applied Scientist responsibilities.
                ...
                \item Designed an adversarial multi-agent evaluation pipeline for agentic solutions,
achieving 90\%+ failure detection rate with 0.78 Cohen's Kappa correlation to expert grades reducing the solution development feedback loop from days to hours and enabling rapid iteration on solution development
                \item Fine-tuned LLMs for specialized legal use case s including long-form contract drafting, customization, and summarization.
            \end{highlights}
        \end{onecolentry}
