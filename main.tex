...
\vspace{0.05 cm}
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Building tool and retrieval-augmented multi-agent systems served via FastAPI with Pinecone vector retrieval that extract and assess risks across high-stakes M\&A due diligence documents, encoding legal expert analysis methodologies into agent workflows in close collaboration with lawyers, identifying 90\%+ of all potential risks.
...
Apache Spark/Databricks, PostgreSQL, Pinecone, Runpod, DigitalOcean, Power BI, Claude Code, Cursor
\end{onecolentry}
