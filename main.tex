...
\vspace{0.05 cm}
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Building tool and retrieval-augmented multi-agent systems that extract and assess risks across high-stakes M\&A due diligence documents, working closely with lawyers to encode their analysis methodologies into agent workflows, identifying 90\%+ of potential risks.
                \item Designed an adversarial evaluation pipeline for agentic solutions with 90\%+ failure detection rate (0.78 Cohen's Kappa vs. expert grades). Eliminated slow manual evaluation bottlenecks, cutting the development feedback loop from days to hours.
                \item Built MCP-enabled agent tools and reusable production skills covering context assembly, tool use, and eval.
...
\vspace{0.06 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item Improved tool use in advanced reasoning LLMs through RLHF training pipelines, enabling them to chain and execute multi-step actions from high-level user intent, powering AI solutions for tech firms including Google and Meta.
                \item Curated instruction tuning and preference datasets alongside domain experts, driving a 20\% improvement in instruction adherence.
            \end{highlights}
        \end{onecolentry}
...
Spark/Databricks, PostgreSQL, Pinecone, Runpod, DigitalOcean, Power BI, MCP, Claude Code, Cursor
\end{onecolentry}
